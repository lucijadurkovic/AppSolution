...
AS
SELECT   dbo.Countries.CountryCode, dbo.Countries.CountryTitle, dbo.Districts.DistrictTitle, dbo.Districts.DistrictType, dbo.Regions.RegionTitle, dbo.Places.PlaceTitle, 
                         dbo.Places.PlaceNationalCode
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vArea';
